...
class Problem:
    ...
    def solve(self):
        ...
        return self.find_largest_manhattan_distance()
    ...
    def find_largest_manhattan_distance(self):
        ...
        for idx, scanner1 in enumerate(self.scanners[:-1]):
            for scanner2 in self.scanners[idx:]:
                dist = self.calculate_manhattan_distance(scanner1.location, scanner2.location)
    ...
    def calculate_manhattan_distance(self, l1, l2):
